module Main where
    ...
    play_handle = do
           new_eventloop 0 Character {_stats = Stats{_hp=40, _strength=10, _skill=5, _speed=10, _luck=5, _defense=5}, _items = [WeaponTag Weapon{_charges=46, _weight=5, _might=5, _hit=90, _crit=0, _minrange=1, _maxrange=1}, PotionTag Potion{_effect=Heal, _remain=3}], _status=Status{_currhp=40, _condition=Healthy}} 
