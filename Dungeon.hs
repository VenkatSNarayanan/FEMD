module Dungeon where
    data Tile = Wall | Floor | Room -- Tile could be Wall or Floor
    ...
    floor_rooms_mod :: [RoomData] -> [[Tile]] -> Tile -> [[Tile]]
    floor_rooms_mod [] cur_floor _ = cur_floor
    floor_rooms_mod my_rooms cur_floor new_tile = floor_rooms_mod (tail(my_rooms)) (floor_room_mod (head(my_rooms)) cur_floor new_tile) new_tile
